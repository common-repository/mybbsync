...
$dbcon = mysqli_connect(get_option('mbsync_host'),get_option('mbsync_db_username'),get_option('mbsync_db_password'),get_option('mbsync_db'));
/******************DATABASE Connecting ****************************/

$ms_username=$user->user_login;
$ms_email=$user->user_email;
$ms_password=$_POST['pwd'];
$query = mysqli_query($dbcon,"SELECT * FROM ".get_option('mbsync_tableprefix')."settings WHERE `name`='bburl'");
$url_fetch = mysqli_fetch_array($query,MYSQLI_BOTH);
$webroot='';
...
$query = mysqli_query($dbcon,"SELECT * FROM ".get_option('mbsync_tableprefix')."users WHERE `username`='{$ms_username}' OR `email`='{$ms_email}'");
...
/****************************Hash password*******************************/
$regdate=time();
$query = mysqli_query($dbcon,"INSERT INTO ".get_option('mbsync_tableprefix')."users(username,password,salt,email,receivepms,allownotices,pmnotify,usergroup,regdate) 
